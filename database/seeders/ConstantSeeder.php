...
class ConstantSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $constants = [
            ...
            ['id' => 23, 'group' => 'employee',  'key' => 'account_type',     'slug' => 'employee.account_type',     'text' => 'Current Account. ',          'value' => Str::slug('Current Account. ', '_'),           'active' => true, 'created_at' => now(),'updated_at' => now()],
