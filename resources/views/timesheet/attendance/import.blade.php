    ...
    <section>
        <div class="container-fluid">
            ...
            {{-- <div class="card">
                ...
                <div class="card-body">
                    <p class="card-text">Please take a note of the date format you get in the CSV file downloaded/exported from your attendance device(CSV). Now from within PandaHcm, go to- customize settings > general Settings and select the same date format from dropdown for the option named- 'Attendance device date format'</p>
