...
<html lang="en">
    <head>
        <title>HrmSolution Installer | Step-4</title>
    ...
    <div class="col-md-6 offset-md-3">
        <div class='wrapper'>
            <header>
                ...
                <h1 class="text-center">PeopleHrmSolutionPro SaaS Auto Installer</h1>
            </header>
            <hr>
            <div class="content pad-top-bot-50">
            <p>
                    <h5><strong class="theme-color">Congratulations!</strong>
                    You have successfully installed HrmSolution SaaS.</h5><br>
